        ...
        <div class="card border mt-3">
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <form action="{{ url('admin/orders/'.$order->id) }}" method="POST">
                            ...
                            <div class="input-group">
                                <select name="order_status" class="form-select">
                                    <option value="" selected="true" default="true" disabled="disabled">Select Order Status</option>
                    ...
                    <div class="col-md-7">
                        <br/>
                        <h5 class="mt-1 float-end">Current Order Status: <span class="text-uppercase text-red">{{ $order->status_message}}</span></h5>
                    </div>
                </div>
            </div>
        </div>
